...
-- Zrzut struktury bazy danych swiat
CREATE DATABASE IF NOT EXISTS `swiat` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `swiat`;

-- Zrzut struktury tabela swiat.city
...
-- Zrzucanie danych dla tabeli swiat.city: 4 079 rows
...
REPLACE INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	...
	(52, 'GhardaÄa', 'DZA', 'GhardaÄa', 89415),
	...
	(206, 'SÄƒo Paulo', 'BRA', 'SÄƒo Paulo', 9968485),
	...
	(217, 'Guarulhos', 'BRA', 'SÄƒo Paulo', 1095874),
	(218, 'GoiÃ¢nia', 'BRA', 'GoiÃ¡s', 1056330),
	(219, 'Campinas', 'BRA', 'SÄƒo Paulo', 950043),
	(220, 'SÄƒo GonÃ§alo', 'BRA', 'Rio de Janeiro', 869254),
	(221, 'Nova IguaÃ§u', 'BRA', 'Rio de Janeiro', 862225),
	(222, 'SÄƒo LuÃ­s', 'BRA', 'MaranhÄƒo', 837588),
	(223, 'MaceiÃ³', 'BRA', 'Alagoas', 786288),
	(224, 'Duque de Caxias', 'BRA', 'Rio de Janeiro', 746758),
	(225, 'SÄƒo Bernardo do Campo', 'BRA', 'SÄƒo Paulo', 723132),
	(226, 'Teresina', 'BRA', 'PiauÃ­', 691942),
	(227, 'Natal', 'BRA', 'Rio Grande do Norte', 688955),
	(228, 'Osasco', 'BRA', 'SÄƒo Paulo', 659604),
	(229, 'Campo Grande', 'BRA', 'Mato Grosso do Sul', 649593),
	(230, 'Santo AndrÃ©', 'BRA', 'SÄƒo Paulo', 630073),
	(231, 'JoÄƒo Pessoa', 'BRA', 'ParaÃ­ba', 584029),
	(232, 'JaboatÄƒo dos Guararapes', 'BRA', 'Pernambuco', 558680),
	(233, 'Contagem', 'BRA', 'Minas Gerais', 520801),
	(234, 'SÄƒo JosÃ© dos Campos', 'BRA', 'SÄƒo Paulo', 515553),
	(235, 'UberlÃ¢ndia', 'BRA', 'Minas Gerais', 487222),
	(236, 'Feira de Santana', 'BRA', 'Bahia', 479992),
	(237, 'RibeirÄƒo Preto', 'BRA', 'SÄƒo Paulo', 473276),
	(238, 'Sorocaba', 'BRA', 'SÄƒo Paulo', 466823),
	...
	(276, 'Itaquaquecetuba', 'BRA', 'SÄƒo Paulo', 270874),
	...
	(286, 'Limeira', 'BRA', 'SÄƒo Paulo', 245497),
	...
	(295, 'GuarujÃ¡', 'BRA', 'SÄƒo Paulo', 237206),
	(296, 'RibeirÄƒo das Neves', 'BRA', 'Minas Gerais', 232685),
	(297, 'Governador Valadares', 'BRA', 'Minas Gerais', 231724),
	(298, 'TaubatÃ©', 'BRA', 'SÄƒo Paulo', 229130),
	(299, 'Imperatriz', 'BRA', 'MaranhÄƒo', 224564),
	(300, 'GravataÃ­', 'BRA', 'Rio Grande do Sul', 223011),
	(301, 'Embu', 'BRA', 'SÄƒo Paulo', 222223),
	(302, 'MossorÃ³', 'BRA', 'Rio Grande do Norte', 214901),
	(303, 'VÃ¡rzea Grande', 'BRA', 'Mato Grosso', 214435),
	(304, 'Petrolina', 'BRA', 'Pernambuco', 210540),
	(305, 'Barueri', 'BRA', 'SÄƒo Paulo', 208426),
	(306, 'ViamÄƒo', 'BRA', 'Rio Grande do Sul', 207557),
	(307, 'Ipatinga', 'BRA', 'Minas Gerais', 206338),
	(308, 'Juazeiro', 'BRA', 'Bahia', 201073),
	(309, 'Juazeiro do Norte', 'BRA', 'CearÃ¡', 199636),
	(310, 'TaboÄƒo da Serra', 'BRA', 'SÄƒo Paulo', 197550),
	(311, 'SÄƒo JosÃ© dos Pinhais', 'BRA', 'ParanÃ¡', 196884),
	(312, 'MagÃ©', 'BRA', 'Rio de Janeiro', 196147),
	(313, 'Suzano', 'BRA', 'SÄƒo Paulo', 195434),
	(314, 'SÄƒo Leopoldo', 'BRA', 'Rio Grande do Sul', 189258),
	(315, 'MarÃ­lia', 'BRA', 'SÄƒo Paulo', 188691),
	(316, 'SÄƒo Carlos', 'BRA', 'SÄƒo Paulo', 187122),
	(317, 'SumarÃ©', 'BRA', 'SÄƒo Paulo', 186205),
	(318, 'Presidente Prudente', 'BRA', 'SÄƒo Paulo', 185340),
	...
	(326, 'Americana', 'BRA', 'SÄƒo Paulo', 177409),
	(327, 'Alvorada', 'BRA', 'Rio Grande do Sul', 175574),
	(328, 'Araraquara', 'BRA', 'SÄƒo Paulo', 174381),
	(329, 'ItaboraÃ­', 'BRA', 'Rio de Janeiro', 173977),
	(330, 'Santa BÃ¡rbara dÂ´Oeste', 'BRA', 'SÄƒo Paulo', 171657),
	(331, 'Nova Friburgo', 'BRA', 'Rio de Janeiro', 170697),
	(332, 'JacareÃ­', 'BRA', 'SÄƒo Paulo', 170356),
	(333, 'AraÃ§atuba', 'BRA', 'SÄƒo Paulo', 169303),
	(334, 'Barra Mansa', 'BRA', 'Rio de Janeiro', 168953),
	(335, 'Praia Grande', 'BRA', 'SÄƒo Paulo', 168434),
	...
	(355, 'Cotia', 'BRA', 'SÄƒo Paulo', 140042),
	(356, 'Lages', 'BRA', 'Santa Catarina', 139570),
	(357, 'Ferraz de Vasconcelos', 'BRA', 'SÄƒo Paulo', 139283),
	(358, 'Indaiatuba', 'BRA', 'SÄƒo Paulo', 135968),
	(359, 'HortolÃ¢ndia', 'BRA', 'SÄƒo Paulo', 135755),
	(360, 'Caxias', 'BRA', 'MaranhÄƒo', 133980),
	(361, 'SÄƒo Caetano do Sul', 'BRA', 'SÄƒo Paulo', 133321),
	(362, 'Itu', 'BRA', 'SÄƒo Paulo', 132736),
	...
	(410, 'Barretos', 'BRA', 'SÄƒo Paulo', 104156),
	(411, 'GuaratinguetÃ¡', 'BRA', 'SÄƒo Paulo', 103433),
	(412, 'Cachoeirinha', 'BRA', 'Rio Grande do Sul', 103240),
	(413, 'CodÃ³', 'BRA', 'MaranhÄƒo', 103153),
	(414, 'JaraguÃ¡ do Sul', 'BRA', 'Santa Catarina', 102580),
	(415, 'CubatÄƒo', 'BRA', 'SÄƒo Paulo', 102372),
	(416, 'Itabira', 'BRA', 'Minas Gerais', 102217),
	(417, 'Itaituba', 'BRA', 'ParÃ¡', 101320),
	(418, 'Araras', 'BRA', 'SÄƒo Paulo', 101046),
	(419, 'Resende', 'BRA', 'Rio de Janeiro', 100627),
	(420, 'Atibaia', 'BRA', 'SÄƒo Paulo', 100356),
	...
	(426, 'SÄƒo JosÃ© de Ribamar', 'BRA', 'MaranhÄƒo', 98318),
	(427, 'Pinhais', 'BRA', 'ParanÃ¡', 98198),
	(428, 'SertÄƒozinho', 'BRA', 'SÄƒo Paulo', 98140),
	...
	(556, 'ViÅ„a del Mar', 'CHL', 'ValparaÃ­so', 312493),
	...
	(670, 'A CoruÅ„a (La CoruÅ„a)', 'ESP', 'Galicia', 243402),
	...
	(680, 'Pamplona [IruÅ„a]', 'ESP', 'Navarra', 180483),
	...
	(699, 'LogroÅ„o', 'ESP', 'La Rioja', 127093),
	...
	(773, 'Las PiÅ„as', 'PHL', 'National Capital Reg', 472780),
	...
	(777, 'ParaÅ„aque', 'PHL', 'National Capital Reg', 449811),
	...
	(782, 'DasmariÅ„as', 'PHL', 'Southern Tagalog', 379520),
	...
	(806, 'BiÅ„an', 'PHL', 'Southern Tagalog', 201186),
	...
	(932, 'Le-Cap-HaÄtien', 'HTI', 'Nord', 102233),
	...
	(1449, 'ReykjavÃ­k', 'ISL', 'HÃ¶fuÄ‘borgarsvÄ‡Ä‘i', 109184),
	...
	(1502, 'ForlÄ›', 'ITA', 'Emilia-Romagna', 107475),
	...
	(1806, 'Maroua', 'CMR', 'ExtrÄ™me-Nord', 143000),
	...
	(1859, 'Praia', 'CPV', 'SÄƒo Tiago', 94800),
	...
	(2302, 'Kisangani', 'COD', 'Haute-ZaÄre', 417517),
	...
	(2641, 'Tlajomulco de ZÃºÅ„iga', 'MEX', 'Jalisco', 123220),
	...
	(2656, 'AcuÅ„a', 'MEX', 'Coahuila de Zaragoza', 110388),
	...
	(2809, 'Trondheim', 'NOR', 'SÅ™r-TrÅ™ndelag', 150166),
	(2810, 'Stavanger', 'NOR', 'Rogaland', 108848),
	(2811, 'BÄ‡rum', 'NOR', 'Akershus', 101340),
	...
	(3050, 'MalmÃ¶', 'SWE', 'SkÄºne lÃ¤n', 259579),
	(3051, 'Uppsala', 'SWE', 'Uppsala lÃ¤n', 189569),
	(3052, 'LinkÃ¶ping', 'SWE', 'East GÃ¶tanmaan lÃ¤n', 133168),
	(3053, 'VÃ¤sterÄºs', 'SWE', 'VÃ¤stmanlands lÃ¤n', 126328),
	(3054, 'Ã–rebro', 'SWE', 'Ã–rebros lÃ¤n', 124207),
	(3055, 'NorrkÃ¶ping', 'SWE', 'East GÃ¶tanmaan lÃ¤n', 122199),
	(3056, 'Helsingborg', 'SWE', 'SkÄºne lÃ¤n', 117737),
	(3057, 'JÃ¶nkÃ¶ping', 'SWE', 'JÃ¶nkÃ¶pings lÃ¤n', 117095),
	(3058, 'UmeÄº', 'SWE', 'VÃ¤sterbottens lÃ¤n', 104512),
	(3059, 'Lund', 'SWE', 'SkÄºne lÃ¤n', 98948),
	(3060, 'BorÄºs', 'SWE', 'West GÃ¶tanmaan lÃ¤n', 96883),
	...
	(3172, 'SÄƒo TomÃ©', 'STP', 'Aqua Grande', 49541),
	...
	(3240, 'Turku [Ä¹bo]', 'FIN', 'Varsinais-Suomi', 172561),
	...
	(3315, 'KÅ™benhavn', 'DNK', 'KÅ™benhavn', 495699),
	(3316, 'Ä¹rhus', 'DNK', 'Ä¹rhus', 284846),
	...
	(3538, 'CittÅ• del Vaticano', 'VAT', 'â€“', 455),
	...
	(3773, 'BiÄ™n Hoa', 'VNM', 'Dong Nai', 282095),
	...
	(3785, 'Phan ThiÄ™t', 'VNM', 'Binh Thuan', 114236),
...
-- Zrzut struktury tabela swiat.country
...
-- Zrzucanie danych dla tabeli swiat.country: 239 rows
...
REPLACE INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
	...
	('ESP', 'Spain', 'Europe', 'Southern Europe', 505992.00, 1492, 39441700, 78.8, 553233.00, 532031.00, 'EspaÅ„a', 'Constitutional Monarchy', 'Juan Carlos I', 653, 'ES'),
	...
	('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399.00, NULL, 43000, 78.4, 0.00, NULL, 'FÅ™royar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
	...
	('GRL', 'Greenland', 'North America', 'North America', 2166090.00, NULL, 56000, 68.1, 0.00, NULL, 'Kalaallit Nunaat/GrÅ™nland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
	...
	('HTI', 'Haiti', 'North America', 'Caribbean', 27750.00, 1804, 8222000, 49.2, 3459.00, 3107.00, 'HaÄti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
	...
	('TMP', 'East Timor', 'Asia', 'Southeast Asia', 14874.00, NULL, 885000, 46.0, 0.00, NULL, 'Timor Timur', 'Administrated by the UN', 'JosÃ© Alexandre GusmÄƒo', 1522, 'TP'),
	...
	('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.00, 1960, 3615000, 44.0, 1054.00, 993.00, 'Centrafrique/BÄ™-AfrÃ®ka', 'Republic', 'Ange-FÃ©lix PatassÃ©', 1889, 'CF'),
	...
	('PRT', 'Portugal', 'Europe', 'Southern Europe', 91982.00, 1143, 9997600, 75.8, 105954.00, 102133.00, 'Portugal', 'Republic', 'Jorge SampÄƒio', 2914, 'PT'),
	...
	('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964.00, 1975, 147000, 65.3, 6.00, NULL, 'SÄƒo TomÃ© e PrÃ­ncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
	...
	('URY', 'Uruguay', 'South America', 'South America', 175016.00, 1828, 3337000, 75.2, 20831.00, 19967.00, 'Uruguay', 'Republic', 'Jorge Batlle IbÃ¡Å„ez', 3492, 'UY'),
	...
	('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.40, 1929, 1000, NULL, 9.00, NULL, 'Santa Sede/CittÅ• del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
	...
	('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689.00, 1945, 79832000, 69.3, 21929.00, 22834.00, 'ViÄ™t Nam', 'Socialistic Republic', 'TrÃ¢n Duc Luong', 3770, 'VN'),
	...
	('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59.00, NULL, 0, NULL, 0.00, NULL, 'BouvetÅ™ya', 'Dependent Territory of Norway', 'Harald V', NULL, 'BV'),
...
-- Zrzut struktury tabela swiat.countrylanguage
...
-- Zrzucanie danych dla tabeli swiat.countrylanguage: 984 rows
